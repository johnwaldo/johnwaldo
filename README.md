...
| User AI session hours | 0.4h | 11.0h | 17.3h | 17.3h |
| AI worker hours | 2.0h | 6.1h | 15.5h | 15.5h |
| AI concurrency hours | 2.7h | 21.0h | 40.7h | 40.7h |
| Interactive sessions | 1 | 7 | 15 | 15 |
| Worker sessions | 25 | 70 | 221 | 221 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 17,003 | 75.9M | 3.2M | 946.2M | $495.53 | $2,554.87 | $2,239.56 |
...
| **Total** | **17,295** | **76.5M** | **3.4M** | **972.8M** | **$580.86** | **$2,828.73** | **$2,262.08** |

_1,054.9M total tokens processed. 92.2% cache hit rate._

_$5,090.81 total saved ($2,828.73 caching + $2,262.08 model routing vs all-Opus)._
...
| **Total** | **115,259** | **78.5M** | **40.0M** | **9,922.9M** | **$12,382.30** | **$58,770.24** | **$10,936.85** |

_13,187.6M total tokens processed. 94.6% cache hit rate._

_$69,707.10 total saved ($58,770.24 caching + $10,936.85 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-02 11:32 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
