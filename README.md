...
| User AI session hours | 0.0h | 2.9h | 36.0h | 73.0h |
| AI worker hours | 0.0h | 52.8h | 53.1h | 53.1h |
| AI concurrency hours | 0.1h | 84.6h | 141.4h | 191.5h |
| Interactive sessions | 2 | 232 | 278 | 297 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 8,684 | 9K | 2.7M | 903.7M | $2,452.59 | $12,201.24 | $0.00 |
| claude-sonnet-4-6 | 49,372 | 51K | 13.8M | 4,091.1M | $2,097.61 | $11,046.02 | $5,741.99 |
...
| **Total** | **59,424** | **1.9M** | **16.9M** | **5,081.3M** | **$4,764.82** | **$24,069.76** | **$5,817.68** |

_5,330.3M total tokens processed. 95.3% cache hit rate._

_$29,887.45 total saved ($24,069.76 caching + $5,817.68 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 36,789 | 44K | 13.1M | 3,914.5M | $6,856.01 | $52,845.85 | $0.00 |
...
| **Total** | **87,295** | **96K** | **27.2M** | **8,069.8M** | **$8,400.28** | **$64,722.74** | **$5,746.89** |

_8,784.6M total tokens processed. 95% cache hit rate._

_$70,469.62 total saved ($64,722.74 caching + $5,746.89 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-01 17:27 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
