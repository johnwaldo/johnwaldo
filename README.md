...
| User AI session hours | 0.4h | 11.2h | 17.3h | 17.3h |
| AI worker hours | 1.7h | 5.9h | 15.4h | 15.4h |
| AI concurrency hours | 2.4h | 21.1h | 40.6h | 40.6h |
| Interactive sessions | 1 | 7 | 15 | 15 |
| Worker sessions | 22 | 69 | 221 | 221 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 16,950 | 75.7M | 3.1M | 945.0M | $494.52 | $2,551.71 | $2,235.05 |
...
| **Total** | **17,242** | **76.3M** | **3.4M** | **971.7M** | **$579.85** | **$2,825.57** | **$2,257.57** |

_1,053.5M total tokens processed. 92.2% cache hit rate._

_$5,083.15 total saved ($2,825.57 caching + $2,257.57 model routing vs all-Opus)._
...
| **Total** | **115,206** | **78.3M** | **40.0M** | **9,921.8M** | **$12,381.29** | **$58,767.09** | **$10,932.35** |

_13,186.1M total tokens processed. 94.6% cache hit rate._

_$69,699.43 total saved ($58,767.09 caching + $10,932.35 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-02 08:31 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
